...
set output 'vnffg_150-450-rem_vnfs.pdf'
set yrange [9.5092:9.5099]
#set xrange [0:5.5]
...
plot "vnffg_150-450-rem_vnfs.csv" using 1 title "Cataloged" with steps ls 1, \
	 "vnffg_150-450-rem_vnfs.csv" using 2 title "Monitored" with steps ls 2, \
	 "vnffg_150-450-rem_vnfs.csv" using 2 notitle with points ls 3 
