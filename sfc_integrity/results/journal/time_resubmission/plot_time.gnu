...
plot "merged_ent_mean_std.csv" using ($1*1000):($2*1000) title "MED" with yerrorbars ls 3, \
		'' using ($1*1000) notitle with lines ls 3, \
		"quant_ent_mean_std.csv" using ($1*1000):($2*1000) title "NED" with yerrorbars ls 4, \
