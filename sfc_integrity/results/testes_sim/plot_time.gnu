...
plot "entropy_mean_std.csv" using ($1*1000):($2*1000) title "Entropy" with yerrorbars ls 1, \
		'' using ($1*1000) notitle with lines ls 1, \
		"comparison_mean_std.csv" using ($1*1000):($2*1000) title "Diff" with yerrorbars ls 2, \
