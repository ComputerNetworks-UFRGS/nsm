...
plot "entropies_c2_only.txt" using 2 title "Merged C2" with steps ls 2, \
	 "entropies_c2_only.txt" using 1 title "Cataloged C2" with steps ls 1, \
	 "entropies_c2_only.txt" using 2 notitle with points ls 3  
