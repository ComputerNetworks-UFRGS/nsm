...
plot "entropies_c1_only.txt" using 2 title "Merged C1" with steps ls 2, \
	 "entropies_c1_only.txt" using 1 title "Cataloged C1" with steps ls 1, \
	 "entropies_c1_only.txt" using 2 notitle with points ls 3  
