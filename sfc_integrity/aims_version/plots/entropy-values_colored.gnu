...
set style line 2 lw 2 lt 2 pt 2 linecolor rgb "dark-grey"
...
plot "entropies_c1.txt" using 2 title "Merged C1" with steps ls 2, \
	 "entropies_c1.txt" using 1 title "Cataloged C1" with steps ls 1, \
	 "entropies_c1.txt" using 1 notitle with points ls 3, \
	 "entropies_c2.txt" using 3 title "Merged C2" with steps ls 2, \
	 "entropies_c2.txt" using 1 title "Cataloged C2" with steps ls 1, \
	 "entropies_c2.txt" using 1 notitle with points ls 3, \
	 "entropies_c3.txt" using 4 title "Merged C3" with steps ls 2, \
	 "entropies_c3.txt" using 1 title "Cataloged C3" with steps ls 1, \
	 "entropies_c3.txt" using 1 notitle with points ls 3, \
	 "entropies_c4.txt" using 5 title "Merged C4" with steps ls 2, \
	 "entropies_c4.txt" using 1 title "Cataloged C4" with steps ls 1, \
	 "entropies_c4.txt" using 1 notitle with points ls 3  
