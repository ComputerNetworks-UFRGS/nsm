...
plot "entropies_c4_only.txt" using 2 title "Merged C4" with steps ls 2, \
	 "entropies_c4_only.txt" using 1 title "Cataloged C4" with steps ls 1, \
	 "entropies_c4_only.txt" using 2 notitle with points ls 3  
